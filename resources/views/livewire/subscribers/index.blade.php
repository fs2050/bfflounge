...
<div class="container_center h-100 pt-4 pt-lg-5">
    ...
    <div class="menu_earnings">
        <ul>
            ...
            <li class="active"><a href="subscribers.html"><i class="las la-users"></i> Inscritos</a></li>
...
<div class="container_right">
    <div class="mb-5">
        <table class="earnings">
            <thead>
                <tr>
                    <th class="nowrap">Data e Hora</th>
            ...
            <tbody>
                <tr>
                    <td>Fev 2, 2022 17:31</td>
                    <td class="text-center">R$ 6,90</td>
                    <td class="text-center">R$ 1,00</td>
                    <td class="text-center">R$ 5,90</td>
                    <td class="small">Inscrição realizada<br>por <span class="c-pink">Ladin Souza</span></td>
                    <td class="text-center"><img src="{{ asset( 'assets/images/loader.gif' ) }}" class="loader" /></td>
                </tr>
                <tr>
                    <td>Fev 2, 2022 17:31</td>
                    <td class="text-center">R$ 6,90</td>
