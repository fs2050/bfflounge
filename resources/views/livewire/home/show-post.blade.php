            ...
            <div class="post">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="comment_reactions">
                                                ...
                                                <div class="comment_date">
                                                    {{ date('d/m/Y'), $post->interactions->user->comments[0]->created_at }}
                                                    às
                                                    {{ date('H:i'), $post->interactions->user->comments[0]->created_at }}
                                                </div>

                                                <div class="comment_like mx-2 mx-lg-4">

                                                    @if (empty($comment->interactions->user->reactions->likes))
                                                    <i class="far fa-heart ml-2">
                                                        <a href="#"
                                                    ...
                                                    <i class="fa-heart ml-2 fas">
                                                        <a href="#"
                                                        wire:click.prevent="unlikeComment('{{ $comment->interactions->reactions->likes[0]->id }}')">
                                                        <i class="fa-heart ml-2 fas"></i>
                                                    </a>
                                                    </i>
                ...
                <div class="new_comment">
                    <div class="d-flex w-100 align-items-center">
                        <div class="new_comment_photo" style="background-image:url(assets/images/users/01.png);">
                        </div>
