            ...
            <div class="post">
                <div class="post_user">
                    ...
                    <div class="post_options">
                        ...
                        <div class="post_date">
                            <span
                                class="d-none d-lg-inline-block">Publicado</span> {{ date('d/m/Y') ,$post->created_at }}
                        </div>
                    </div>
                </div>
                @if( !$post->medias == null )
                ...
                <div class="post_comments">
                    <div class="post_comment">
                        <form action="#" name="demo">
                            <input class="form-control" type="text" placeholder="Escreva um comentário"
                                   name="hiddenfield"
                                   aria-label="default input example" onkeypress="return enter(document.demo.send)">
                            Field 1:
