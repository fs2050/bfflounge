                    ...
                    <div class="post_comment">
                        ...
                        @foreach ($post->interactions->comments as $comment)
                            <div class="comment_user">
                                ...
                                <div class="comment_photo" style="background-image:url(assets/images/users/02.png);">
                                </div>
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="comment_reactions">
                                                ...
                                                <div class="comment_like mx-2 mx-lg-4">
                                                    ...
                                                    @else
                                                        <a href="#"
                                                            wire:click.prevent="unlikeComment('{{ $comment->interactions->user->reactions->likes[0]->id }}')">
                                                            <i class="fa-heart ml-2 fas"></i>
                                                        </a>
                                                    @endif
                                    ...
                                    <form wire:submit.prevent="commentComment('{{ $comment->id }}')">
                                        ...
                                        <div class="new_comment">
                                            ...
                                            <div class="d-flex w-100 align-items-center">
                                                ...
                                                <div class="new_comment_photo"
                                                    style="background-image:url(assets/images/users/01.png);"></div>

                                                <div class="new_comment_text flex-1">
                                                    <textarea placeholder="Comentar como {{ session('user')->name }}"
                                                        wire:model.defer="contentCommentComment"></textarea>
                                                </div>
                            ...
                            @foreach ($comment->interactions->comments as $commentsComments)
                                <div class="comment_user">
                                    ...
                                    <div class="comment_photo"
                                        style="background-image:url(assets/images/users/02.png);"></div>
                                                ...
                                                <div class="comment_reactions">
                                                    ...
                                                    <div class="comment_like mx-2 mx-lg-4">
                                                        ...
                                                        @if (empty($commentsComments->interactions->user->reactions->likes))
                                                            <a href="#"
                                                                wire:click.prevent="likeCommentComment('{{ $commentsComments->id }}')">
                                                                <i class="far fa-heart ml-2"></i>
                                                            </a>
                                                        @else
                                                            <a href="#"
                                                                wire:click.prevent="unlikeCommentComment('{{ $commentsComments->interactions->user->reactions->likes[0]->id }}')">
                                                                <i class="fa-heart ml-2 fas"></i>
                                                            </a>
                                                        @endif
