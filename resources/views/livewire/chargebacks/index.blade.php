...
<div class="container_center h-100 pt-4 pt-lg-5">
    ...
    <div class="menu_earnings">
        <ul>
            <li class="active"><a href="{{ route( 'chargebacks.index' ) }}"><i class="las la-list"></i> Lista de Estornos</a></li>
        ...
        <table class="earnings">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="small">Realizado por<br><span class="c-pink">Ladin Souza</span></td>
